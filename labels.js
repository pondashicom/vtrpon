...
const labels = {
  "ja": {
    ...
    "screen-lock-background-settings-title": "ロック背景画像設定",
    "screen-lock-background-description": "スクリーンロック中にメイン画面へ表示する背景画像を設定します",
    "screen-lock-background-current-label": "現在の設定",
    "screen-lock-background-select-button": "画像を選択",
  ...
  "en": {
    ...
    "screen-lock-background-description": "Configure the background image shown on the main window while screen lock is active",
    "screen-lock-background-current-label": "Current Setting",
    "screen-lock-background-select-button": "Select Image",
